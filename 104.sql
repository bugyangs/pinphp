...
-- Dumping database structure for pinphp
CREATE DATABASE IF NOT EXISTS `pinphp` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `pinphp`;


-- Dumping structure for table pinphp.pin_ad
...
-- Dumping data for table pinphp.pin_ad: 21 rows
/*!40000 ALTER TABLE `pin_ad` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_ad` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_adboard
...
-- Dumping data for table pinphp.pin_adboard: 14 rows
/*!40000 ALTER TABLE `pin_adboard` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_adboard` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_admin
...
-- Dumping data for table pinphp.pin_admin: 1 rows
/*!40000 ALTER TABLE `pin_admin` DISABLE KEYS */;
INSERT INTO `pin_admin` (`id`, `username`, `password`, `role_id`, `last_ip`, `last_time`, `email`, `status`) VALUES
	(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, '', 0, 'haipi51@126.com', 1);
/*!40000 ALTER TABLE `pin_admin` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_admin_auth
...
-- Dumping data for table pinphp.pin_admin_auth: 0 rows
/*!40000 ALTER TABLE `pin_admin_auth` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_admin_auth` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_admin_role
...
-- Dumping data for table pinphp.pin_admin_role: 1 rows
/*!40000 ALTER TABLE `pin_admin_role` DISABLE KEYS */;
INSERT INTO `pin_admin_role` (`id`, `name`, `remark`, `ordid`, `status`) VALUES
	(1, '超级管理员', '超级管理员', 0, 1);
/*!40000 ALTER TABLE `pin_admin_role` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_album
...
-- Dumping data for table pinphp.pin_album: 15 rows
/*!40000 ALTER TABLE `pin_album` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_album` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_album_cate
...
-- Dumping data for table pinphp.pin_album_cate: 27 rows
/*!40000 ALTER TABLE `pin_album_cate` DISABLE KEYS */;
INSERT INTO `pin_album_cate` (`id`, `name`, `img`, `ordid`, `albums`, `status`, `seo_title`, `seo_keys`, `seo_desc`) VALUES
	...
	(26, '原单', '', 0, 0, 1, '', '', ''),
	(27, 'OL', '', 0, 0, 1, '', '', '');
/*!40000 ALTER TABLE `pin_album_cate` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_album_comment
...
-- Dumping data for table pinphp.pin_album_comment: 0 rows
/*!40000 ALTER TABLE `pin_album_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_album_comment` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_album_follow
...
-- Dumping data for table pinphp.pin_album_follow: 0 rows
/*!40000 ALTER TABLE `pin_album_follow` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_album_follow` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_album_item
...
-- Dumping data for table pinphp.pin_album_item: 62 rows
/*!40000 ALTER TABLE `pin_album_item` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_album_item` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_article
...
-- Dumping data for table pinphp.pin_article: 0 rows
/*!40000 ALTER TABLE `pin_article` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_article` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_article_cate
...
-- Dumping data for table pinphp.pin_article_cate: 7 rows
/*!40000 ALTER TABLE `pin_article_cate` DISABLE KEYS */;
INSERT INTO `pin_article_cate` (`id`, `type`, `name`, `alias`, `img`, `pid`, `spid`, `ordid`, `status`, `seo_title`, `seo_keys`, `seo_desc`) VALUES
	...
	(6, 1, '积分规则', '', '', 5, '5|', 255, 1, '', '', ''),
	(7, 1, '兑换说明', '', '', 5, '5|', 255, 1, '', '', '');
/*!40000 ALTER TABLE `pin_article_cate` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_article_page
...
-- Dumping data for table pinphp.pin_article_page: 5 rows
/*!40000 ALTER TABLE `pin_article_page` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_article_page` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_auto_user
...
-- Dumping data for table pinphp.pin_auto_user: 1 rows
/*!40000 ALTER TABLE `pin_auto_user` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_auto_user` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_badword
...
-- Dumping data for table pinphp.pin_badword: 0 rows
/*!40000 ALTER TABLE `pin_badword` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_badword` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_flink
...
-- Dumping data for table pinphp.pin_flink: 1 rows
/*!40000 ALTER TABLE `pin_flink` DISABLE KEYS */;
INSERT INTO `pin_flink` (`id`, `name`, `img`, `url`, `cate_id`, `ordid`, `status`) VALUES
	(1, 'PinPHP', '', 'http://www.pinphp.com', 1, 0, 1);
/*!40000 ALTER TABLE `pin_flink` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_flink_cate
...
-- Dumping data for table pinphp.pin_flink_cate: 1 rows
/*!40000 ALTER TABLE `pin_flink_cate` DISABLE KEYS */;
INSERT INTO `pin_flink_cate` (`id`, `name`, `ordid`, `status`) VALUES
	(1, '友情链接', 255, 1);
/*!40000 ALTER TABLE `pin_flink_cate` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_ipban
...
-- Dumping data for table pinphp.pin_ipban: 0 rows
/*!40000 ALTER TABLE `pin_ipban` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_ipban` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_item
...
-- Dumping data for table pinphp.pin_item: 62 rows
/*!40000 ALTER TABLE `pin_item` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_item` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_item_attr
...
-- Dumping data for table pinphp.pin_item_attr: 0 rows
/*!40000 ALTER TABLE `pin_item_attr` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_item_attr` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_item_cate
...
-- Dumping data for table pinphp.pin_item_cate: 326 rows
/*!40000 ALTER TABLE `pin_item_cate` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_item_cate` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_item_cate_tag
...
-- Dumping data for table pinphp.pin_item_cate_tag: 313 rows
/*!40000 ALTER TABLE `pin_item_cate_tag` DISABLE KEYS */;
INSERT INTO `pin_item_cate_tag` (`cate_id`, `tag_id`, `weight`) VALUES
	...
	(332, 417, 0),
	(332, 418, 0);
/*!40000 ALTER TABLE `pin_item_cate_tag` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_item_comment
...
-- Dumping data for table pinphp.pin_item_comment: 0 rows
/*!40000 ALTER TABLE `pin_item_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_item_comment` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_item_img
...
-- Dumping data for table pinphp.pin_item_img: 283 rows
/*!40000 ALTER TABLE `pin_item_img` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_item_img` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_item_like
...
-- Dumping data for table pinphp.pin_item_like: 0 rows
/*!40000 ALTER TABLE `pin_item_like` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_item_like` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_item_orig
...
-- Dumping data for table pinphp.pin_item_orig: 2 rows
/*!40000 ALTER TABLE `pin_item_orig` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_item_orig` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_item_site
...
-- Dumping data for table pinphp.pin_item_site: 1 rows
/*!40000 ALTER TABLE `pin_item_site` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_item_site` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_item_tag
...
-- Dumping data for table pinphp.pin_item_tag: 590 rows
/*!40000 ALTER TABLE `pin_item_tag` DISABLE KEYS */;
INSERT INTO `pin_item_tag` (`item_id`, `tag_id`) VALUES
	...
	(62, 334),
	(62, 335);
/*!40000 ALTER TABLE `pin_item_tag` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_mail_queue
...
-- Dumping data for table pinphp.pin_mail_queue: 0 rows
/*!40000 ALTER TABLE `pin_mail_queue` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_mail_queue` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_menu
...
-- Dumping data for table pinphp.pin_menu: 150 rows
/*!40000 ALTER TABLE `pin_menu` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_menu` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_message
...
-- Dumping data for table pinphp.pin_message: 0 rows
/*!40000 ALTER TABLE `pin_message` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_message` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_message_tpl
...
-- Dumping data for table pinphp.pin_message_tpl: 2 rows
/*!40000 ALTER TABLE `pin_message_tpl` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_message_tpl` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_nav
...
-- Dumping data for table pinphp.pin_nav: 8 rows
/*!40000 ALTER TABLE `pin_nav` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_nav` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_oauth
...
-- Dumping data for table pinphp.pin_oauth: 3 rows
/*!40000 ALTER TABLE `pin_oauth` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_oauth` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_score_item
...
-- Dumping data for table pinphp.pin_score_item: 0 rows
/*!40000 ALTER TABLE `pin_score_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_score_item` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_score_item_cate
...
-- Dumping data for table pinphp.pin_score_item_cate: 6 rows
/*!40000 ALTER TABLE `pin_score_item_cate` DISABLE KEYS */;
INSERT INTO `pin_score_item_cate` (`id`, `name`, `status`, `ordid`) VALUES
	...
	(5, '运动', 1, 0),
	(6, '吃完', 1, 0);
/*!40000 ALTER TABLE `pin_score_item_cate` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_score_log
...
-- Dumping data for table pinphp.pin_score_log: 15 rows
/*!40000 ALTER TABLE `pin_score_log` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_score_log` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_score_order
...
-- Dumping data for table pinphp.pin_score_order: 0 rows
/*!40000 ALTER TABLE `pin_score_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_score_order` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_setting
...
-- Dumping data for table pinphp.pin_setting: 39 rows
/*!40000 ALTER TABLE `pin_setting` DISABLE KEYS */;
INSERT INTO `pin_setting` (`name`, `data`, `remark`) VALUES
	...
	('index_wall', '1', '');
/*!40000 ALTER TABLE `pin_setting` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_tag
...
-- Dumping data for table pinphp.pin_tag: 419 rows
/*!40000 ALTER TABLE `pin_tag` DISABLE KEYS */;
INSERT INTO `pin_tag` (`id`, `name`) VALUES
	...
	(418, '米黄'),
	(419, '跟鞋');
/*!40000 ALTER TABLE `pin_tag` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_topic
...
-- Dumping data for table pinphp.pin_topic: 62 rows
/*!40000 ALTER TABLE `pin_topic` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_topic` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_topic_at
...
-- Dumping data for table pinphp.pin_topic_at: 0 rows
/*!40000 ALTER TABLE `pin_topic_at` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_topic_at` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_topic_comment
...
-- Dumping data for table pinphp.pin_topic_comment: 0 rows
/*!40000 ALTER TABLE `pin_topic_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_topic_comment` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_topic_index
...
-- Dumping data for table pinphp.pin_topic_index: 0 rows
/*!40000 ALTER TABLE `pin_topic_index` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_topic_index` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_topic_relation
...
-- Dumping data for table pinphp.pin_topic_relation: 0 rows
/*!40000 ALTER TABLE `pin_topic_relation` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_topic_relation` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_user
...
-- Dumping data for table pinphp.pin_user: 20 rows
/*!40000 ALTER TABLE `pin_user` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_user` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_user_address
...
-- Dumping data for table pinphp.pin_user_address: 0 rows
/*!40000 ALTER TABLE `pin_user_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_user_address` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_user_bind
...
-- Dumping data for table pinphp.pin_user_bind: 0 rows
/*!40000 ALTER TABLE `pin_user_bind` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_user_bind` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_user_follow
...
-- Dumping data for table pinphp.pin_user_follow: 0 rows
/*!40000 ALTER TABLE `pin_user_follow` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_user_follow` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_user_msgtip
...
-- Dumping data for table pinphp.pin_user_msgtip: 0 rows
/*!40000 ALTER TABLE `pin_user_msgtip` DISABLE KEYS */;
/*!40000 ALTER TABLE `pin_user_msgtip` ENABLE KEYS */;


-- Dumping structure for table pinphp.pin_user_stat
...
-- Dumping data for table pinphp.pin_user_stat: 15 rows
/*!40000 ALTER TABLE `pin_user_stat` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pin_user_stat` ENABLE KEYS */;
